...
const cursor = (state, action) => {
    switch (action.type) {
        ...
        case 'PAINTTOOL_CURSOR_POSITION_SIZE_RESET':
            state = state.setIn(['rotate', 'angle'], 0);
