...
const Position = ({ viewMode, bracket, operationMouseDown, operationMouseUp, positionChangeViewMode, bracketSelect }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', width: 80, height: 80, justifyContent: 'space-between', alignItems: 'center' }}>
            <div
              id={`${viewMode}TopCircle`}
              style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '10%', width: '100%', cursor: 'pointer', fontSize: 25, marginLeft: 10 }}
            ...
            <div style={{ display: 'flex', width: '100%', height: '80%' }}>
                <div id={`${viewMode}LeftCircle`} style={{ cursor: 'pointer', width: '10%', height: '100%', display: 'flex', alignItems: 'center', fontSize: 25 }} onMouseDown={operationMouseDown({ viewMode, bracket, direction: 'left' })} onMouseUp={operationMouseUp({ viewMode, bracket, direction: 'left' })} role="presentation"> ● </div>
                <div style={{ width: '80%', height: '100%', marginLeft: 10, marginTop: '2%' }}>
                ...
                <div id={`${viewMode}RightCircle`} style={{ cursor: 'pointer', width: '10%', height: '100%', display: 'flex', alignItems: 'center', fontSize: 25 }} onMouseDown={operationMouseDown({ viewMode, bracket, direction: 'right' })} onMouseUp={operationMouseUp({ viewMode, bracket, direction: 'right' })} role="presentation"> ● </div>
            </div>
            <div id={`${viewMode}BottomCircle`} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '10%', width: '100%', cursor: 'pointer', fontSize: 25, marginLeft: 10 }} onMouseDown={operationMouseDown({ viewMode, bracket, direction: 'bottom' })} onMouseUp={operationMouseUp({ viewMode, bracket, direction: 'bottom' })} role="presentation"> ● </div>
        </div>
    );
};
